using System;
/*Nesse código acho importante ressaltar algo que ouvi do professor durante está aula em específico, 
e fiquei de fato impactado.*/
/*Ao ser indagado por um aluno, sobre como utilizaria o código da busca binária na prática,
o professor disse o seguinte:
Fulano, aí que está! Você usará busca binária no seu dia a dia, 
e chegará uma hora que sequer se dará conta de que está usando um algoritmo parecido com esse, 
visto que as linguagens já lhe dão um objeto para a busca. Mas aí eu lhe pergunto:
Quantos programadores sabem como funciona o objeto por debaixo dos panos? 
Quantos seriam capazes de refazer um algoritmo de busca binária na mão grande?

Resultado: Desde então estou tentando sintetizar a ideia desse algoritmo e o refazendo, 
para reproduzi-lo numa situação apocaliptica =O */
